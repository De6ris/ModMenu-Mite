...
import io.github.prospector.modmenu.util.TextureUtils;
import net.minecraft.FontRenderer;
import net.minecraft.Minecraft;
import net.minecraft.Tessellator;
import org.lwjgl.opengl.GL11;

public class ModMenuTexturedButtonWidget extends ModMenuButtonWidget {
    ...
    protected ModMenuTexturedButtonWidget(int x, int y, int width, int height, int u, int v, String texture) {
        this(x, y, width, height, u, v, texture, 256, 256);
    }

    protected ModMenuTexturedButtonWidget(int x, int y, int width, int height, int u, int v, String texture, int uWidth, int vHeight) {
        this(x, y, width, height, u, v, texture, uWidth, vHeight, "");
    }

    protected ModMenuTexturedButtonWidget(int x, int y, int width, int height, int u, int v, String texture, int uWidth, int vHeight, String message) {
...
//			GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.getTextureManager().getTexture(texture));
